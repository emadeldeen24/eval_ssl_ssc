...
parser.add_argument('--run_description',        default='attn',     type=str, help='run name')

# ========= Select methods ============
parser.add_argument('--sleep_model',              default='resnet1d',          type=str, help='dsn, attnsleep, cnn1d')
parser.add_argument('--ssl_method',              default='simclr',        type=str, help='simclr, cpc, ts_tcc, clsTran')
parser.add_argument('--train_mode',              default='supervised',            type=str, help='supervised, ssl, (ft)fine_tune, (lc)linear_classifier')
